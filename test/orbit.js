...
describe("Orbit", function() {
  describe("Calculating orbital elements from state vectors", function() {
    ...
    before(function() {
      var r = Vector.create([-6045, -3490, 2500]),
          v = Vector.create([-3.457, 6.618, 2.533]);
    ...
    it("angularMomentum", function() {
      var actual = orbit.angularMomentum(),
          expected = Vector.create([-25385.17, 6669.485, -52070.74]);
    ...
    it("eccentricity", function() {
      var actual = orbit.eccentricity(),
          expected = Vector.create([-0.091604, -0.142207, 0.026443]);
      expect(actual.eql(expected)).to.be.true;
    });
    ...
    it("nodeLine", function() {
      var actual = orbit.nodeLine(),
          expected = Vector.create([-6669.485, -25385.17, 0.0]);
      expect(actual.eql(expected)).to.be.true;
    });
  ...
  describe("Updating state after dt", function() {
    ...
    beforeEach(function() {
      var r = Vector.create([7000, -12124, 0]),
          v = Vector.create([2.6679, 4.6210, 0]);
    ...
    it("update", function() {
      ...
      var rExpected = Vector.create([-3297.768625, 7413.396645, 0.0]),
          vExpected = Vector.create([-8.297603, -0.9640449, -0.0]);
  ...
  describe("Set state with common params", function() {
    ...
    it("state", function() {
      var rExpected = Vector.create([-4039.895923, 4814.560480, 3628.624702]),
          vExpected = Vector.create([-10.385987, -4.771921, 1.743875]);
  ...
  describe("Set state with apogee and perigee", function() {
    ...
    it("state", function() {
      var rExpected = Vector.create([1311.563646, 4699.598648, 4701.881415]),
          vExpected = Vector.create([-5.641883, 4.379639, -2.8037407]);
